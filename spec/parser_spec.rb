...
EOD
  ...
  {
    timetable: [
      ['15:30', '開場 / 受付にてお名刺を1枚頂戴いたします。'],
      ['16:00', '原 和裕さん / ゲームやアプリを作る上で、とても重要にキーポイントの一つであるキャラクターデザインや絵コンテの制作に関して、パワーポイントや画像・動画を交えてお話し頂きます。これは必見！'],
      ['16:40', '@itoKami1123さん / XCodeのStoryboad機能を使って画面を作る方法を 初心者でも分かる形で説明！ プロジェクターを使用ながら、自身の経験談を交えてお話し頂きます。'],
      ['17:15', '矢野 弘展さん / アプリ・ゲーム・コンテンツ・・・これらを作る上で"ディレクションや構成"は絶対に欠かすことはできない重要な部分です。 しっかりとした企画・構成をディレクションしていく、これが成功への鍵。 多彩な経験を元に生み出された"鍵"を伝授して頂きます。'],
      ['18:00', '交流会 / ちょっとした飲み物とおつまみをご用意。'],
    ],
    doc: <<'EOD'
<h2>◆タイムテーブル◆</h2>
<table>
  ...
  <tr>
    <td>15:30 &#8211; 16:00</td>
    <td>開場</td>
    <td>受付にてお名刺を1枚頂戴いたします。</td>
  </tr>
  <tr>
    <td>16:00 &#8211; 16:30</td>
    <td>原 和裕さん</td>
    <td>ゲームやアプリを作る上で、とても重要にキーポイントの一つである<br />キャラクターデザインや絵コンテの制作に関して、パワーポイントや画像・動画を交えてお話し頂きます。これは必見！<br />
</td>
  </tr>
  <tr>
  </tr>
  <tr>
    <td>16:40 &#8211; 17:10</td>
    <td>@itoKami1123さん</td>
    <td>XCodeのStoryboad機能を使って画面を作る方法を<br />
初心者でも分かる形で説明！<br />
プロジェクターを使用ながら、自身の経験談を交えてお話し頂きます。<br />
  </tr>
  </tr>
  <tr>
    <td>17:15 &#8211; 18:00</td>
    <td>矢野 弘展さん</td>
    <td>アプリ・ゲーム・コンテンツ・・・これらを作る上で"ディレクションや構成"は<br />絶対に欠かすことはできない重要な部分です。<br />
しっかりとした企画・構成をディレクションしていく、これが成功への鍵。<br />
多彩な経験を元に生み出された"鍵"を伝授して頂きます。<br /></td>
  </tr>
  <tr>
    <td>18:00- 19:00</td>
    <td>交流会</td>
    <td> ちょっとした飲み物とおつまみをご用意。</td>
  </tr></table>
EOD
  },
